...
def pad_words_char(word, char_pad_token, max_word_length):
    """
    pad a word to the maximum length
    :param word:
    :param char_pad_token:
...
def pad_sents_char(sents, char_pad_token):
    ...
    for s in sents:
        s = s[:max_sent_length]
        s = [pad_words_char(w, char_pad_token, max_word_length) for w in s]
        padded_sent = [pad_words_char([], char_pad_token, max_word_length) for _ in range(max_sent_length-len(s))]
        sents_padded.append(s+padded_sent)
    ### END YOUR CODE
...
def pad_sents(sents, pad_token):
    ...
    for s in sents:
        sents_padded.append(s + [pad_token] * (longest_len - len(s)))
